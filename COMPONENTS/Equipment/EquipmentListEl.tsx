        ...
        <TableRow sx={{ "& .MuiTableCell-root": { textAlign: "center", cursor: "pointer", padding: "4px 32px" } }} hover onClick={() => router.push(`/equipment/${equipment.id}`)}>
            ...
            <TableCell>
                <div className="flex items-center">
                    <div className="h-28 w-28 overflow-hidden flex items-center relative rounded-md">
                        {/* add max-h-[128px] to image if you want the image to resize */}
                        <Image loading="lazy" className="max-w-28 rounded-md" src={equipment.equipmentImage ? equipment.equipmentImage : "/window.svg"} width={112} height={112} alt="Equipment image" />
