            ...
            <div className="grid grid-cols-2 gap-2">
                <Controller
                    ...
                    render={({ field }) => (
                        <TextField
                            type="number"
                            label={level[0] === "I" ? "Interval in months" : "Working Hours Interval"}
                            color="info"
                            margin="dense"
                            ...
                            helperText={level[0] === "I" ? "Interval between certification tasks in months (if present)" : "Interval between maintenance tasks in hours (if present)"}
                        />
                    )}
                />
                <Controller
