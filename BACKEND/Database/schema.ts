...
export const maintenances = pgTable("maintenances", {
  ...
  equipmentId: integer("equipment_id").notNull().references(() => equipments.id, { onDelete: "cascade" }),
  tenantId: integer("tenant_id").notNull().references(()=>tenants.id, { onDelete: "cascade" }),
  givenHealthIndex: integer("given_health_index").notNull(),
  ...
  levelAMonths: integer("level_a_months").notNull().default(0),
  levelADuration: integer("level_a_duration").notNull().default(0),
  levelBHours: integer("level_b_hours").notNull().default(0),
  levelBMonths: integer("level_b_months").notNull().default(0),
  levelBDuration: integer("level_b_duration").notNull().default(0),
  levelCHours: integer("level_c_hours").notNull().default(0),
  levelCMonths: integer("level_c_months").notNull().default(0),
  levelCDuration: integer("level_c_duration").notNull().default(0),
  levelDHours: integer("level_d_hours").notNull().default(0),
  levelDMonths: integer("level_d_months").notNull().default(0),
  levelDDuration: integer("level_d_duration").notNull().default(0),
  levelI1Duration: integer("level_i_duration_1").notNull().default(0),
  levelI1Months: integer("level_i_months_1").notNull().default(0),
  levelI1Description: varchar("level_i_description_1", { length: 255 }),
  levelI2Duration: integer("level_i_duration_2").notNull().default(0),
  levelI2Months: integer("level_i_months_2").notNull().default(0),
  levelI2Description: varchar("level_i_description_2", { length: 255 }),
  levelI3Duration: integer("level_i_duration_3").notNull().default(0),
  levelI3Months: integer("level_i_months_3").notNull().default(0),
  levelI3Description: varchar("level_i_description_3", { length: 255 }),
  levelI4Duration: integer("level_i_duration_4").notNull().default(0),
  levelI4Months: integer("level_i_months_4").notNull().default(0),
  levelI4Description: varchar("level_i_description_4", { length: 255 }),
  levelI5Duration: integer("level_i_duration_5").notNull().default(0),
  levelI5Months: integer("level_i_months_5").notNull().default(0),
  levelI5Description: varchar("level_i_description_5", { length: 255 }),
